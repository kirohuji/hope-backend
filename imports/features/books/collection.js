...
export const BookPostQuestionCollection = new Mongo.Collection(
  "books_posts_questions"
);
export const BookPostQuestionAnswerCollection = new Mongo.Collection(
  "books_posts_questions_answers"
);
