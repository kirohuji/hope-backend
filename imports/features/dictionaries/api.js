import Api from "../../api";
import Model, { DictionaryOption, DictionaryCollection, DictionaryOptionCollection } from './collection'
...
Api.addRoute('dictionaries/options/findOne', {
    post: function () {
        return DictionaryOptionCollection.findOne(this.bodyParams.selector || {}, this.bodyParams.options)
    }
});
...
Api.addRoute('dictionaries/options/pagination', {
    post: function () {
        return {
            data: DictionaryOption.find(this.bodyParams.selector || {}, this.bodyParams.options).fetch(),
