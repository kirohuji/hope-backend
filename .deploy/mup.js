  ...
  app: {
    ...
    docker: {
      ...
      buildInstructions: [
        ...
        'RUN npm config set puppeteer_download_host https://npmmirror.com/mirrors/chrome-for-testing',
